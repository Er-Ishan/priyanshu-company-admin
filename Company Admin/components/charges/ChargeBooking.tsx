...
export default function AmendedCharges() {
  ...
  const fetchCharges = async () => {
    setLoading(true);
    try {
      const res = await fetch(backendProxyPath("/api/charges/booking"), {
        credentials: "include",
      });
      ...
      console.error("Failed to fetch booking charges:", err);
      setRows([]);
    } finally {
      setLoading(false);
    }
    ...
    <ProtectedRoute>
      <div className="w-full mb-10">
        ...
        <div className="flex justify-between items-center mb-3 border-b py-2">
          <h2 className="text-lg font-semibold">Booking Charges</h2>
          <Button
