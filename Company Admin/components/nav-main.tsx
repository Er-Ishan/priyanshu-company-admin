                ...
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton
                      ...
                      className={cn(
                        "cursor-pointer py-5.5 px-3 text-base text-muted-foreground hover:text-foreground data-[state=open]:bg-primary data-[state=open]:text-primary-foreground hover:data-[state=open]:bg-primary dark:hover:data-[state=open]:bg-primary hover:data-[state=open]:text-primary-foreground hover:bg-accent active:bg-accent/80",
                        isOpen
                        ...
                        return (
                          <SidebarMenuSubItem key={subItem.title}>
                            <SidebarMenuSubButton
                              asChild
                              className={cn(
                                "py-5.5 px-3 text-base text-muted-foreground hover:text-foreground hover:bg-accent active:bg-accent/80",
                                isSubActive
            ...
            return (
              <SidebarMenuItem key={item.title}>
                <SidebarMenuButton
                  ...
                  tooltip={item.title}
                  className={cn(
                    "cursor-pointer py-5.5 px-3 text-base text-muted-foreground hover:text-foreground hover:bg-accent active:bg-accent/80",
                    isMenuActive
