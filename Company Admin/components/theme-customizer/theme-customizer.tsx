...
const ThemeCustomizer = () => {
    ...
    return (
        <>
            <Button
                className="fixed bottom-12 end-8 !p-0 shadow-xl rounded-full w-[50px] h-[50px] bg-primary text-primary-foreground flex items-center justify-center overflow-hidden z-[50]"
                onClick={() => setCustomizationOpen(true)}
            >
                <Settings className="!w-7 !h-7 animate-spin fill-current" />
            </Button>
