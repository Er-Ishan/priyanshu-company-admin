...
"[project]/app/(dashboard)/Suppliers-Info/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function BookingsPage() {
    ...
    =========================================================== */ const fetchData = async ()=>{
        ...
        try {
            ...
            const res = await fetch(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$backendProxy$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["backendProxyPath"])("/api/supplier-booking")}?${qs}`, {
                credentials: "include"
            });
...
//# sourceMappingURL=_85fe5b1f._.js.map