...
"[project]/.next-internal/server/app/api/session/me/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function getUserFromDb(identifier, password) {
    try {
        const backendUrl = process.env.API_BACKEND_URL || ("TURBOPACK compile-time value", "https://adminback.fleetcart.co.uk") || "http://localhost:9000";
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            authorize: async (credentials)=>{
                try {
                    ...
                    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserFromDb"])(identifier, password);
                    if (!user) {
        ...
        async session ({ session, token }) {
            if (session.user) {
                ...
                if (token?.company_id) {
                    ...
                    session.user.company_domain = token.company_domain;
                    session.user.support_email_address = token.support_email_address;
                    session.user.support_contact_no = token.support_contact_no;
                }
            }
            return session;
        }
...
"[project]/app/api/session/me/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7916143a._.js.map