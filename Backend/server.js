...
// Resolve .env from project root before any other imports
...
import marketingSourceRoutes from "./routes/marketingSourceRoutes.js";

import syncBookingsToJobs from "./asyncFunction/syncBookingsToJobs.js";
...
app.use(cors({
  origin: [
	...
	"https://crm.fleetcart.co.uk",
	"https://admincrm.fleetcart.co.uk",
...
app.use("/api/jobs", syncBookingsToJobs);
...
app.use("/api", marketingSourceRoutes);
